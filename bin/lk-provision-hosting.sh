...

{
    ...
    FILE=/etc/hosts
    lk_arr_from IP_ADDRESS lk_system_list_public_network_ips
    IPV4_ADDRESS=$(lk_arr IP_ADDRESS | lk_filter_ipv4) || IPV4_ADDRESS=
    IPV6_ADDRESS=$(lk_arr IP_ADDRESS | lk_filter_ipv6) || IPV6_ADDRESS=
